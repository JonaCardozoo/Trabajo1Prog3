...
public class GenerarLista {
	...
	// Getters and Setters
	public double getMayorPromedio() {
		return MayorPromedio;
	}

	public void setMayorPromedio(double mayorPromedio) {
		MayorPromedio = mayorPromedio;
	}

	public double getMenorPromedio() {
		return MenorPromedio;
	}

	public void setMenorPromedio(double menorPromedio) {
